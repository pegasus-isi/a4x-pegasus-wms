...
function usage {
    echo "Usage: run_lulesh_300_10.sh -i <input> ... -o <output> ..."
    echo "Options:"
    echo "========"
...
flux run --nodes=1 --ntasks=1 --cores-per-task=1 --exclusive /a4x/orchestration/repo/tests/lulesh/build/lulesh2.0 -s 300 -i 10 -p